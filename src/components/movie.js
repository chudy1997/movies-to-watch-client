...
class Movie extends Component {
    ...
    render(){
        ...
        return (
            ...
            >
                <td style={{width: "20px"}}><input className="watched-checkbox" type="checkbox" checked={this.props.movie.status} onClick={e => e.stopPropagation()} onChange={this.handleClick} /></td>
                <td>{title}</td>
                <td>{year}</td>
                <td>{runtime}</td>
                <td>{genre}</td>
